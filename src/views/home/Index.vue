    ...
    <div class="page index" ref="page" @scroll="pageScroll">
        ...
        <div class="cblock cate-block">
            <van-grid :column-num="4" :border="false" icon-size="50px">
                ...
                >
                    <van-image width="40" height="40" :src="cate.icon"/>
                    <
                </van-grid-item>
            </van-grid>
        </div>
...
<script lang="ts">
    ...
    export default class Home extends Vue {
        private images = [require('../../assets/images/swipe1.jpeg'), require('../../assets/images/swipe2.jpeg')];
        private fourads = [{
            image: '',
            title: '',
            ext: ''
        ...
        private cates = [{
            ...
            id: 1,
            icon: require('../../assets/images/icon/paybag.png'),
            title: '零食'
        }, {
            id: 2,
        ...
        private products = [];
        private value = "";
        private navbgClass = "bg-transparent";
